...
async function main() {
  ...
  console.log("Registering EASPortal on the PortalRegistry...");
  await portalRegistry.register(
    easPortalAddress,
    "EAS Portal",
    "Ethereum Attestation Service compatible Portal",
    false,
    "Consensys",
  );
  ...
  console.log(`DefaultPortal = ${defaultPortalAddress}`);
  //console.log(`EASPortal = ${easPortalAddress}`);

  console.log(`END SCRIPT`);

  ["0x8173FD66EC40B793C679F834063A5D0802975B4496ACBA0B39ED8B6C2B3FCA57", "0x12", 110, "0x12"];
}
