...
describe("AttestationRegistry", () => {
  describe("handleAttestationRegistered()", () => {
    ...
    test("Should create a new Attestation entity and audit data", () => {
      ...
      assert.fieldEquals(
        ...
        "expirationDate",
        expirationDate.toU64().toString(),
      );
      assert.fieldEquals(
        "Attestation",
        attestationId.toHexString(),
        "revocationDate",
        revocationDate.toU64().toString(),
      );
  ...
  describe("handleAttestationReplacedEvent()", () => {
    ...
    test("Should update the Attestation entity's replacedBy", () => {
      ...
      const updatedReplacedBy = Bytes.fromHexString(
  ...
  describe("handleVersionUpdated()", () => {
    ...
    test("Should update the RegistryVersion entity", () => {
      ...
      assert.entityCount("RegistryVersion", 1);
      assert.fieldEquals("RegistryVersion", "registry-version", "versionNumber", "2");
    });
  });
});
