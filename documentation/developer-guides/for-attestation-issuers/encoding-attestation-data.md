...
attestation data. In order this to happen, the attestation data must first be encoded using `abi.encode`.
...
Sometime a schema is a bit more complicated, in that it contains more than just a flat data structure, and may contain
