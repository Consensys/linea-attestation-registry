...
contract IndexerModuleTest is Test {
  using ECDSA for bytes32;

  IndexerModule private indexerModule;
  ...
  function setUp() public {
    ...
    indexerModule = new IndexerModule(address(router));
  ...
  function test_run() public {
    ...
    indexerModule.run(payload3, bytes(""), address(0), 0);
