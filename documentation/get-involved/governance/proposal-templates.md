...
{% hint style="info" %} The following proposal templates should be used when submitting a proposal to the community
forums so that they can be reviewed and discussed. These templates are embedded into the forums themselves, and so these
are simply for reference. {% endhint %}
